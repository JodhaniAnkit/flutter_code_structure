...
import 'package:flutter_structure/global/widgets/common_widgets.dart';
import 'package:flutter_structure/global/widgets/select_file.dart';
...
class UserProfile extends StatelessWidget {
  ...
  buildPickImg() {
    return InkWell(
        ...
        child: Icon(Icons.camera_alt,size: Get.height * 0.070));
  ...
  buildDefaultImg() {
    ...
    child:Icon(Icons.camera_alt,size: Get.height * 0.16,)));
  }
